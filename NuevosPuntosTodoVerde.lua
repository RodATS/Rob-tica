...
function sysCall_init()
    ...
    waypoints[7] = {2,1.5}
    waypoints[8] = {2,1.95}
    waypoints[9] = {2,2} -- 4 goal
    waypoints[10] = {1.5,1.5}
    --
    waypoints[11] = {1,1}
    waypoints[12] = {0,0.05}
    waypoints[13] = {0,0} -- 1 goal
    waypoints[14] = {1,1}
    waypoints[15] = {0.5,1.5} 
    waypoints[16] = {-0.5, 2}
    --
    waypoints[17] = {-1,1.25}
    waypoints[18] = {-2,0.5} 
    waypoints[19] = {-2,1.95} 
    waypoints[20] = {-2,2} -- 2 goal
    waypoints[21] = {-2,1.5}
    waypoints[22] = {-2,1}
    waypoints[23] = {-2,0.5}
    waypoints[24] = {-2,0}
    waypoints[25] = {-2,-0.5}
    waypoints[26] = {-2,-0.95}
    waypoints[27] = {-2,-1} -- 5 goal
    waypoints[28] = {-1,-1.5}
    waypoints[29] = {-1.5,-1.75} 
    waypoints[30] = {-2,-2}
    waypoints[31] = {-1.75,-2.25}
    waypoints[32] = {-0.5,-2.25}
    waypoints[33] = {1,-2.25}
    waypoints[34] = {1.5,-2.25}
    waypoints[35] = {2,-2.05}
    ----------------
    
    -- Waypoints iniciales de los goals
    IndicesWaypointRuta = {}
    IndicesWaypointRuta[1] = 13 -- (0, 0)
    IndicesWaypointRuta[2] = 20 -- (-2, 2)
    IndicesWaypointRuta[3] = 1 -- (2, -2)
    IndicesWaypointRuta[4] = 9 -- (2, 2)
    IndicesWaypointRuta[5] = 27 -- (-2, -1)
    ...
    contadorMedidas = 0
    MaximoMedidas = 12
    MaximoMedidasGoal = 48 -- Take more measurments at goal
